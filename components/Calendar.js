    ...
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-5 gap-4">
        <button
          ...
          className="mr-auto text-primary-400 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
        ...
        <button
          ...
          className="ml-auto text-primary-400 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
          <i className="fa-solid fa-circle-chevron-right"></i>
        </button>
      </div>
      <div className="grid grid-cols-7 gap-4 text-center text-primary-400">
        {dayList.map((day, index) => (
          <p key={index}>{day.charAt(0)}</p>
        ))}
      </div>
                ...
                return (
                  <div
                    ...
                    className={
                      ...
                      (isToday ? " border-purple-400" : " border-primary-100") +
                      (color === "white" ? " text-primary-400" : " text-black")
                    }
                    key={dayOfWeekIndex}
                  >
                    <p>{dayIndex}</p>
